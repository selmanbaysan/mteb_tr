...
from .tur.ArguAnaTR import *
from .tur.CQADupstackGamingRetrievalTR import *
from .tur.FiQA2018TR import *
from .tur.MSMarcoTR import *
from .tur.NFCorpusRetrievalTR import *
from .tur.QuoraRetrievalTR import *
from .tur.SCIDOCSTR import *
from .tur.SciFactTR import *
